CREATE TEMPORARY TABLE viewtable7709 AS select distinct alias6."depid" as "depid", 
...
CREATE TEMPORARY TABLE viewtable7710 AS select distinct alias0."depid" as "depid", 
...
CREATE TEMPORARY TABLE viewtable7711 AS select distinct alias6."depid" as "depid", 
alias6."uniid" as "uniid", 
alias6."advisorid" as "advisorid" from 
"public"."students" alias6 
where 
...
CREATE TEMPORARY TABLE viewtable7712 AS select distinct alias7."depid" as "depid", 
...
CREATE TEMPORARY TABLE viewtable7713 AS select distinct alias0."advisorid" as "advisorid", 
...
CREATE TEMPORARY TABLE viewtable7714 AS select distinct alias3."depid" as "depid", 
...
CREATE TEMPORARY TABLE viewtable7715 AS select distinct alias7."depid" as "depid", 
alias7."uniid" as "uniid", 
alias7."teacherid" as "teacherid" from 
"public"."courses" alias7 
where 
...
CREATE TEMPORARY TABLE viewtable7716 AS select distinct alias0."depid" as "depid", 
alias0."uniid" as "uniid", 
alias0."advisorid" as "advisorid" from 
"public"."students" alias0 
where 
...
CREATE TEMPORARY TABLE viewtable7717 AS select distinct alias9."depid" as "depid", 
...
CREATE TEMPORARY TABLE viewtable7718 AS select distinct alias0."depid" as "depid", 
alias0."uniid" as "uniid", 
alias0."advisorid" as "advisorid" from 
"public"."students" alias0 
where 
...
CREATE TEMPORARY TABLE viewtable7719 AS select distinct alias0."depid" as "depid", 
alias0."uniid" as "uniid", 
alias0."advisorid" as "advisorid" from 
"public"."students" alias0 
where 
...
CREATE TEMPORARY TABLE viewtable7720 AS select distinct alias8."depid" as "depid", 
...
CREATE TEMPORARY TABLE viewtable7721 AS select distinct alias6."depid" as "depid", 
alias6."uniid" as "uniid", 
alias6."advisorid" as "advisorid" from 
"public"."students" alias6 
where 
...
CREATE TEMPORARY TABLE viewtable7722 AS select distinct alias0."advisorid" as "advisorid", 
alias0."depid" as "depid", 
alias0."uniid" as "uniid" from 
"public"."students" alias0 
where 
...
CREATE TEMPORARY TABLE viewtable7723 AS select distinct alias3."depid" as "depid", 
alias3."uniid" as "uniid", 
alias3."teacherid" as "teacherid" from 
"public"."courses" alias3 
where 
...
CREATE TEMPORARY TABLE viewtable7724 AS select distinct alias6."depid" as "depid", 
alias6."uniid" as "uniid", 
alias6."advisorid" as "advisorid" from 
"public"."students" alias6 
where 
...
CREATE TEMPORARY TABLE viewtable7725 AS select distinct alias8."depid" as "depid", 
alias8."uniid" as "uniid", 
alias8."advisorid" as "advisorid" from 
"public"."students" alias8 
where 
...
CREATE TEMPORARY TABLE viewtable7726 AS select distinct alias8."depid" as "depid", 
alias8."uniid" as "uniid", 
alias8."advisorid" as "advisorid" from 
"public"."students" alias8 
where 
...
CREATE TEMPORARY TABLE viewtable7727 AS select distinct alias9."depid" as "depid", 
alias9."uniid" as "uniid", 
alias9."teacherid" as "teacherid" from 
"public"."courses" alias9 
where 
...
CREATE TEMPORARY TABLE viewtable7728 AS select distinct alias8."depid" as "depid", 
alias8."uniid" as "uniid", 
alias8."advisorid" as "advisorid" from 
"public"."students" alias8 
where 
...
"public"."takescourses" qview2,
"public"."courses" qview3,
viewtable7724 qview4,
viewtable7726 qview5
WHERE 
(qview1."stype" = 1) AND
(qview1."advisortype" = 3) AND
qview1."advisorid" IS NOT NULL AND
...
"public"."takescourses" qview2,
"public"."courses" qview3,
viewtable7710 qview4,
viewtable7720 qview5
WHERE 
(qview1."stype" = 1) AND
(qview1."advisortype" = 2) AND
qview1."advisorid" IS NOT NULL AND
...
"public"."takescourses" qview2,
"public"."courses" qview3,
viewtable7715 qview4,
viewtable7717 qview5
WHERE 
(qview1."stype" = 1) AND
(qview1."advisortype" = 2) AND
qview1."advisorid" IS NOT NULL AND
...
"public"."takescourses" qview2,
"public"."courses" qview3,
viewtable7720 qview4,
viewtable7722 qview5
WHERE 
(qview1."stype" = 0) AND
(qview1."advisortype" = 2) AND
qview1."depid" IS NOT NULL AND
