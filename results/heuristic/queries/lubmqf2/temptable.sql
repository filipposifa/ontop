...
(((students.advisortype = 2) and (students.stype = 0)) or ((students.advisortype = 2) and (students.stype = 1))) and 
...
from
students alias0 , t alias1 , takescourses alias2 , courses alias3 , teachers alias5 
where 
alias0.uniid <? and
alias0.stype = 1 and 
