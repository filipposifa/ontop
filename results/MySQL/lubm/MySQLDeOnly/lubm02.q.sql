CREATE TEMPORARY TABLE viewtable562 AS select distinct alias1.`masterD` as "masterD" from 
`teachers` alias1 
where 
(alias1.`ttype` = 0 or (alias1.`ttype` = 3 or (alias1.`ttype` = 1 or alias1.`ttype` = 2))) and 
alias1.`masterD` IS NOT NULL

create temporary table viewtable563 as select * from viewtable562;
create temporary table viewtable564 as select * from viewtable562;
create temporary table viewtable565 as select * from viewtable562;
create temporary table viewtable566 as select * from viewtable562;
create temporary table viewtable567 as select * from viewtable562;
create temporary table viewtable568 as select * from viewtable562;
CREATE TEMPORARY TABLE viewtable570 AS select distinct alias2.`masterD` as "masterD" from 
`teachers` alias2 
where 
(alias2.`ttype` = 0 or (alias2.`ttype` = 3 or (alias2.`ttype` = 1 or alias2.`ttype` = 2))) and 
alias2.`masterD` IS NOT NULL

CREATE TEMPORARY TABLE viewtable572 AS select distinct alias2.`docD` as "docD" from 
`teachers` alias2 
where 
(alias2.`ttype` = 0 or (alias2.`ttype` = 3 or (alias2.`ttype` = 1 or alias2.`ttype` = 2))) and 
alias2.`docD` IS NOT NULL

create temporary table viewtable573 as select * from viewtable572;
create temporary table viewtable574 as select * from viewtable572;
create temporary table viewtable575 as select * from viewtable572;
CREATE TEMPORARY TABLE viewtable577 AS select distinct alias4.`degreeuniid` as "degreeuniid" from 
`students` alias4 
where 
alias4.`stype` = 1 and 
alias4.`degreeuniid` IS NOT NULL

create temporary table viewtable578 as select * from viewtable577;
create temporary table viewtable579 as select * from viewtable577;
create temporary table viewtable580 as select * from viewtable577;
CREATE TEMPORARY TABLE viewtable582 AS select distinct alias2.`underD` as "underD" from 
`teachers` alias2 
where 
(alias2.`ttype` = 0 or (alias2.`ttype` = 3 or (alias2.`ttype` = 1 or alias2.`ttype` = 2))) and 
...
create temporary table viewtable584 as select * from viewtable582;
create temporary table viewtable585 as select * from viewtable582;
CREATE TEMPORARY TABLE viewtable587 AS select distinct alias1.`docD` as "docD" from 
`teachers` alias1 
where 
(alias1.`ttype` = 0 or (alias1.`ttype` = 3 or (alias1.`ttype` = 1 or alias1.`ttype` = 2))) and 
alias1.`docD` IS NOT NULL

create temporary table viewtable588 as select * from viewtable587;
create temporary table viewtable589 as select * from viewtable587;
create temporary table viewtable590 as select * from viewtable587;
CREATE TEMPORARY TABLE viewtable592 AS select distinct alias5.`degreeuniid` as "degreeuniid" from 
`students` alias5 
where 
alias5.`stype` = 1 and 
alias5.`degreeuniid` IS NOT NULL

CREATE TEMPORARY TABLE viewtable594 AS select distinct alias0.`degreeuniid` as "degreeuniid" from 
`students` alias0 
where 
alias0.`stype` = 1 and 
...
CREATE TEMPORARY TABLE viewtable598 AS select distinct alias1.`underD` as "underD" from 
`teachers` alias1 
where 
(alias1.`ttype` = 0 or (alias1.`ttype` = 3 or (alias1.`ttype` = 1 or alias1.`ttype` = 2))) and 
alias1.`underD` IS NOT NULL

create temporary table viewtable599 as select * from viewtable598;
create temporary table viewtable600 as select * from viewtable598;
create temporary table viewtable601 as select * from viewtable598;
SELECT 
