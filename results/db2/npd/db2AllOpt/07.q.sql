SELECT
   ...
   5 AS "NGLQuestType", NULL AS "NGLLang", CAST(var0 AS VARCHAR(500)) AS "NGL", 
   5 AS "conQuestType", NULL AS "conLang", CAST(var1 AS VARCHAR(500)) AS "con", 
   5 AS "oilQuestType", NULL AS "oilLang", CAST(var2 AS VARCHAR(500)) AS "oil", 
   4 AS "monthQuestType", NULL AS "monthLang", CAST(var3 AS VARCHAR(500)) AS "month", 
   4 AS "yearQuestType", NULL AS "yearLang", CAST(var4 AS VARCHAR(500)) AS "year", 
   5 AS "maxOEQuestType", NULL AS "maxOELang", CAST(var5 AS VARCHAR(500)) AS "maxOE", 
   5 AS "gasQuestType", NULL AS "gasLang", CAST(var6 AS VARCHAR(500)) AS "gas"
FROM (
 (
SELECT DISTINCT 
