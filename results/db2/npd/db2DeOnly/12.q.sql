...
SELECT 
   ...
   3 AS "lenghtMQuestType", NULL AS "lenghtMLang", CAST(QVIEW1."WLBTOTALCORELENGTH" * 0.3048 AS VARCHAR(500)) AS "lenghtM", 
...
((QVIEW6."WLBCOMPLETIONYEAR" >= 2008) AND ((QVIEW1."WLBTOTALCORELENGTH" * 0.3048) > 50))
UNION
SELECT 
   7 AS "wellboreQuestType", NULL AS "wellboreLang", QVIEW5."WLBWELLBORENAME" AS "wellbore", 
...
((QVIEW8."WLBCOMPLETIONYEAR" >= 2008) AND ((QVIEW1."WLBTOTALCORELENGTH" * 0.3048) > 50))
UNION
SELECT 
   7 AS "wellboreQuestType", NULL AS "wellboreLang", QVIEW5."WLBWELLBORENAME" AS "wellbore", 
...
((QVIEW5."WLBCOMPLETIONYEAR" >= 2008) AND ((QVIEW1."WLBTOTALCORELENGTH" * 0.3048) > 50))
UNION
SELECT 
   7 AS "wellboreQuestType", NULL AS "wellboreLang", QVIEW5."WLBWELLBORENAME" AS "wellbore", 
...
((QVIEW7."WLBCOMPLETIONYEAR" >= 2008) AND ((QVIEW1."WLBTOTALCORELENGTH" * 0.3048) > 50))
UNION
SELECT 
   7 AS "wellboreQuestType", NULL AS "wellboreLang", QVIEW5."WLBWELLBORENAME" AS "wellbore", 
   4 AS "yearQuestType", NULL AS "yearLang", CAST(QVIEW7."WLBCOMPLETIONYEAR" AS VARCHAR(500)) AS "year", 
