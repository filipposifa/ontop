CREATE TEMPORARY TABLE SESSION.viewtable572 AS select distinct alias1."DOCD" as "DOCD" from 
"PUBLIC"."TEACHERS" alias1 
where 
(alias1."TTYPE" = 0 or (alias1."TTYPE" = 3 or (alias1."TTYPE" = 1 or alias1."TTYPE" = 2))) and 
alias1."DOCD" IS NOT NULL

CREATE TEMPORARY TABLE SESSION.viewtable573 AS select distinct alias4."DEGREEUNIID" as "DEGREEUNIID" from 
"PUBLIC"."STUDENTS" alias4 
where 
alias4."STYPE" = 1 and 
alias4."DEGREEUNIID" IS NOT NULL

CREATE TEMPORARY TABLE SESSION.viewtable574 AS select distinct alias0."UNDERD" as "UNDERD" from 
"PUBLIC"."TEACHERS" alias0 
where 
(alias0."TTYPE" = 0 or (alias0."TTYPE" = 3 or (alias0."TTYPE" = 1 or alias0."TTYPE" = 2))) and 
alias0."UNDERD" IS NOT NULL

CREATE TEMPORARY TABLE SESSION.viewtable575 AS select distinct alias1."UNDERD" as "UNDERD" from 
"PUBLIC"."TEACHERS" alias1 
where 
(alias1."TTYPE" = 0 or (alias1."TTYPE" = 3 or (alias1."TTYPE" = 1 or alias1."TTYPE" = 2))) and 
alias1."UNDERD" IS NOT NULL

CREATE TEMPORARY TABLE SESSION.viewtable576 AS select distinct alias0."MASTERD" as "MASTERD" from 
"PUBLIC"."TEACHERS" alias0 
where 
(alias0."TTYPE" = 0 or (alias0."TTYPE" = 3 or (alias0."TTYPE" = 1 or alias0."TTYPE" = 2))) and 
alias0."MASTERD" IS NOT NULL

CREATE TEMPORARY TABLE SESSION.viewtable577 AS select distinct alias0."DOCD" as "DOCD" from 
"PUBLIC"."TEACHERS" alias0 
where 
(alias0."TTYPE" = 0 or (alias0."TTYPE" = 3 or (alias0."TTYPE" = 1 or alias0."TTYPE" = 2))) and 
alias0."DOCD" IS NOT NULL

CREATE TEMPORARY TABLE SESSION.viewtable578 AS select distinct alias2."DEGREEUNIID" as "DEGREEUNIID" from 
"PUBLIC"."STUDENTS" alias2 
where 
alias2."STYPE" = 1 and 
alias2."DEGREEUNIID" IS NOT NULL

CREATE TEMPORARY TABLE SESSION.viewtable579 AS select distinct alias1."MASTERD" as "MASTERD" from 
"PUBLIC"."TEACHERS" alias1 
where 
(alias1."TTYPE" = 0 or (alias1."TTYPE" = 3 or (alias1."TTYPE" = 1 or alias1."TTYPE" = 2))) and 
...
SESSION.VIEWTABLE572 QVIEW3,
SESSION.VIEWTABLE577 QVIEW4
WHERE 
(QVIEW1."STYPE" = 1) AND
...
"PUBLIC"."STUDENTS" QVIEW1,
"PUBLIC"."DEPARTMENTS" QVIEW2,
SESSION.VIEWTABLE577 QVIEW3,
SESSION.VIEWTABLE578 QVIEW4
WHERE 
(QVIEW1."STYPE" = 1) AND
(QVIEW1."UNIID" = QVIEW1."DEGREEUNIID") AND
QVIEW1."DEPID" IS NOT NULL AND
...
"PUBLIC"."STUDENTS" QVIEW1,
"PUBLIC"."DEPARTMENTS" QVIEW2,
SESSION.VIEWTABLE574 QVIEW3,
SESSION.VIEWTABLE575 QVIEW4
WHERE 
(QVIEW1."STYPE" = 1) AND
(QVIEW1."UNIID" = QVIEW1."DEGREEUNIID") AND
QVIEW1."DEPID" IS NOT NULL AND
...
"PUBLIC"."STUDENTS" QVIEW1,
"PUBLIC"."DEPARTMENTS" QVIEW2,
SESSION.VIEWTABLE573 QVIEW3,
SESSION.VIEWTABLE574 QVIEW4
WHERE 
(QVIEW1."STYPE" = 1) AND
(QVIEW1."UNIID" = QVIEW1."DEGREEUNIID") AND
QVIEW1."DEPID" IS NOT NULL AND
