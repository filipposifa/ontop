CREATE TEMPORARY TABLE viewtable240 AS select distinct alias0."docD" as "docD" from 
"public"."teachers" alias0 
where 
(alias0."ttype" = 0 or (alias0."ttype" = 3 or (alias0."ttype" = 1 or alias0."ttype" = 2)))

CREATE TEMPORARY TABLE viewtable241 AS select distinct alias3."degreeuniid" as "degreeuniid" from 
"public"."students" alias3 
where 
alias3."stype" = 1

CREATE TEMPORARY TABLE viewtable242 AS select distinct alias1."docD" as "docD" from 
"public"."teachers" alias1 
where 
(alias1."ttype" = 0 or (alias1."ttype" = 3 or (alias1."ttype" = 1 or alias1."ttype" = 2))) and 
alias1."docD" IS NOT NULL and 
alias1."docD" IS NOT NULL and 
alias1."docD" IS NOT NULL and 
alias1."docD" IS NOT NULL and 
alias1."docD" IS NOT NULL and 
...
CREATE TEMPORARY TABLE viewtable243 AS select distinct alias0."underD" as "underD" from 
"public"."teachers" alias0 
where 
(alias0."ttype" = 0 or (alias0."ttype" = 3 or (alias0."ttype" = 1 or alias0."ttype" = 2)))

CREATE TEMPORARY TABLE viewtable244 AS select distinct alias1."masterD" as "masterD" from 
"public"."teachers" alias1 
where 
(alias1."ttype" = 0 or (alias1."ttype" = 3 or (alias1."ttype" = 1 or alias1."ttype" = 2)))

CREATE TEMPORARY TABLE viewtable245 AS select distinct alias4."degreeuniid" as "degreeuniid" from 
"public"."students" alias4 
where 
alias4."stype" = 1 and 
alias4."degreeuniid" IS NOT NULL and 
alias4."degreeuniid" IS NOT NULL and 
alias4."degreeuniid" IS NOT NULL and 
alias4."degreeuniid" IS NOT NULL and 
alias4."degreeuniid" IS NOT NULL and 
...
CREATE TEMPORARY TABLE viewtable246 AS select distinct alias5."degreeuniid" as "degreeuniid" from 
"public"."students" alias5 
where 
alias5."stype" = 1 and 
alias5."degreeuniid" IS NOT NULL and 
alias5."degreeuniid" IS NOT NULL and 
alias5."degreeuniid" IS NOT NULL and 
alias5."degreeuniid" IS NOT NULL and 
alias5."degreeuniid" IS NOT NULL and 
...
CREATE TEMPORARY TABLE viewtable247 AS select distinct alias1."docD" as "docD" from 
"public"."teachers" alias1 
where 
(alias1."ttype" = 0 or (alias1."ttype" = 3 or (alias1."ttype" = 1 or alias1."ttype" = 2)))

CREATE TEMPORARY TABLE viewtable248 AS select distinct alias0."masterD" as "masterD" from 
"public"."teachers" alias0 
where 
(alias0."ttype" = 0 or (alias0."ttype" = 3 or (alias0."ttype" = 1 or alias0."ttype" = 2)))

CREATE TEMPORARY TABLE viewtable249 AS select distinct alias1."underD" as "underD" from 
"public"."teachers" alias1 
where 
(alias1."ttype" = 0 or (alias1."ttype" = 3 or (alias1."ttype" = 1 or alias1."ttype" = 2)))
