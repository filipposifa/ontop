...
SELECT 
   ...
   4 AS "idQuestType", NULL AS "idLang", CAST(qview1."tufNpdidTuf" AS VARCHAR(10485760)) AS "id", 
...
SELECT 
   1 AS "countryQuestType", NULL AS "countryLang", 'http://dbpedia.org/resource/Singapore' AS "country", 
   4 AS "idQuestType", NULL AS "idLang", CAST(qview1."fclNpdidFacility" AS VARCHAR(10485760)) AS "id", 
