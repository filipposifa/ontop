CREATE TEMPORARY TABLE SESSION.viewtable6922 AS select distinct alias3."WLBNPDIDWELLBORE" as "WLBNPDIDWELLBORE" from 
"PUBLIC"."WELLBORE_CORE" alias3 
where 
alias3."WLBNPDIDWELLBORE" IS NOT NULL and 
alias3."WLBNPDIDWELLBORE" IS NOT NULL

CREATE TEMPORARY TABLE SESSION.viewtable6923 AS select distinct alias2."WLBNPDIDWELLBORERECLASS" as "WLBNPDIDWELLBORERECLASS" from 
...
CREATE TEMPORARY TABLE SESSION.viewtable6924 AS select distinct alias0."WLBNPDIDWELLBORERECLASS" as "WLBNPDIDWELLBORERECLASS" from 
"PUBLIC"."WELLBORE_EXPLORATION_ALL" alias0

CREATE TEMPORARY TABLE SESSION.viewtable6925 AS select distinct alias3."WLBNPDIDWELLBORE" as "WLBNPDIDWELLBORE" from 
"PUBLIC"."WELLBORE_CORE" alias3

CREATE TEMPORARY TABLE SESSION.viewtable6926 AS select distinct alias4."WLBNPDIDWELLBORERECLASS" as "WLBNPDIDWELLBORERECLASS" from 
"PUBLIC"."WELLBORE_EXPLORATION_ALL" alias4 
where 
alias4."WLBNPDIDWELLBORERECLASS" IS NOT NULL and 
alias4."WLBNPDIDWELLBORERECLASS" IS NOT NULL

CREATE TEMPORARY TABLE SESSION.viewtable6927 AS select distinct alias2."WLBNPDIDWELLBORERECLASS" as "WLBNPDIDWELLBORERECLASS" from 
"PUBLIC"."WELLBORE_DEVELOPMENT_ALL" alias2
