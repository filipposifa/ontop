...
SELECT 
   ...
   4 AS "idQuestType", NULL AS "idLang", CAST(QVIEW1."TUFNPDIDTUF" AS VARCHAR(4000)) AS "id", 
...
SELECT 
   1 AS "countryQuestType", NULL AS "countryLang", 'http://dbpedia.org/resource/Singapore' AS "country", 
   4 AS "idQuestType", NULL AS "idLang", CAST(QVIEW1."FCLNPDIDFACILITY" AS VARCHAR(4000)) AS "id", 
