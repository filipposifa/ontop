SELECT
   ...
   4 AS "y1QuestType", NULL AS "y1Lang", CAST(var1 AS VARCHAR(500)) AS "y1", 
   4 AS "y2QuestType", NULL AS "y2Lang", CAST(var2 AS VARCHAR(500)) AS "y2", 
   3 AS "y3QuestType", NULL AS "y3Lang", CAST(var3 AS VARCHAR(500)) AS "y3"
FROM (
 (
SELECT 
   QVIEW1."ID" as var0, 
